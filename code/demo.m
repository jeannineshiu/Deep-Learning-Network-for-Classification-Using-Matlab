...
% Last Modified by GUIDE v2.5 24-May-2018 20:19:57
...
% handles    structure with handles and user data (see GUIDATA)
global fullFilename
[filename,pathname] = uigetfile({'*.jpg';'*.bmp'},'Load image');
...
% handles    structure with handles and user data (see GUIDATA)
global fullFilename
load('D:\桌面用\程語\專題\trained_net3.mat');

digitDatasetPath = fullfile(fullFilename);

testData = imageDatastore(digitDatasetPath, ...
    'IncludeSubfolders',true,'LabelSource','foldernames');

plabel = classify(CNNnet3,testData);
set (handles.text1,'String',char(plabel));
